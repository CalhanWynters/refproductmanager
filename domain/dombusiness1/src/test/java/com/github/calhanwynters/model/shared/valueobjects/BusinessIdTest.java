...
class BusinessIdTest {
    ...
    void testBusinessIdCreationWithValidValue() {
        ...
        BusinessId businessId = new BusinessId(validUuid);
    ...
    void testBusinessIdCreationWithNullValueThrowsException() {
        ...
        NullPointerException exception = assertThrows(NullPointerException.class, () -> new BusinessId(null));
    ...
    void testBusinessIdCreationWithEmptyValueThrowsException() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new BusinessId(""));
    ...
    void testGenerateCreatesUniqueAndValidIds() {
        BusinessId id1 = BusinessId.generate();
        BusinessId id2 = BusinessId.generate();
    ...
    void testEqualsAndHashCode() {
        ...
        BusinessId id1 = new BusinessId(uuidString);
        BusinessId id2 = new BusinessId(uuidString);
        BusinessId id3 = BusinessId.generate(); // A different ID
